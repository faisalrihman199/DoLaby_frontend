...
const Calendar = () => {
  ...
  const initialLooks = [
    { id: 1, image: look1Image, title: 'Look 18', folder: 'look_1' },
    { id: 2, image: look2Image, title: 'Look 19', folder: 'look_2' },
    { id: 3, image: look3Image, title: 'Look 20', folder: 'look_3' },
    { id: 4, image: look4Image, title: 'Look 21', folder: 'look_4' },
  ];
